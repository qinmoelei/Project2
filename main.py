...
import sys
import struct
from transform_pdf import trasnform_text_pdf
sys.path.append(".")
from raid6 import *
from utils import *
...
def main():
    ...
    trasnform_text_pdf(text_missing,"save_pdf/missing_one_text.pdf")
    ...
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_one_text_recovery.pdf")
    ...
    text_missing = hex_chunks_to_string(text_data_chunk)
    print("missing text", text_missing)
    trasnform_text_pdf(text_missing,"save_pdf/missing_P_text.pdf")
    data_chunks, parity_chunk_p, parity_chunk_q = datamanager.rebuild_data(
        data_chunks, failure_nodes_id_list
    )
    for id in failure_nodes_id_list:
    ...
    text_data_chunk = data_chunks[:-2]
    print("recover text", datamanager.reshow_text(text_data_chunk))
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_P_text_recovery.pdf")
    ...
    text_missing = hex_chunks_to_string(text_data_chunk)
    print("missing text", text_missing)
    trasnform_text_pdf(text_missing,"save_pdf/missing_Q_text.pdf")
    data_chunks, parity_chunk_p, parity_chunk_q = datamanager.rebuild_data(
        data_chunks, failure_nodes_id_list
    )
    for id in failure_nodes_id_list:
    ...
    text_data_chunk = data_chunks[:-2]
    print("recover text", datamanager.reshow_text(text_data_chunk))
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_Q_text_recovery.pdf")
    ...
    text_missing = hex_chunks_to_string(text_data_chunk)
    print("missing text", text_missing)
    trasnform_text_pdf(text_missing,"save_pdf/missing_Q_one_data_text.pdf")
    data_chunks, parity_chunk_p, parity_chunk_q = datamanager.rebuild_data(
        data_chunks, failure_nodes_id_list
    )
    for id in failure_nodes_id_list:
    ...
    text_data_chunk = data_chunks[:-2]
    print("recover text", datamanager.reshow_text(text_data_chunk))
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_Q_one_data_text_recovery.pdf")
    ...
    text_missing = hex_chunks_to_string(text_data_chunk)
    print("missing text", text_missing)
    trasnform_text_pdf(text_missing,"save_pdf/missing_P_one_data_text.pdf")
    data_chunks, parity_chunk_p, parity_chunk_q = datamanager.rebuild_data(
        data_chunks, failure_nodes_id_list
    )
    for id in failure_nodes_id_list:
    ...
    text_data_chunk = data_chunks[:-2]
    print("recover text", datamanager.reshow_text(text_data_chunk))
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_P_one_data_text_recovery.pdf")
    ...
    text_missing = hex_chunks_to_string(text_data_chunk)
    print("missing text", text_missing)
    trasnform_text_pdf(text_missing,"save_pdf/missing_two_data_text.pdf")
    ...
    text_data_chunk = data_chunks[:-2]
    print("recover text", datamanager.reshow_text(text_data_chunk))
    trasnform_text_pdf(datamanager.reshow_text(text_data_chunk),"save_pdf/missing_two_data_text_recovery.pdf")
